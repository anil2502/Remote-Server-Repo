...
#     mcp.run(transport="http", host="0.0.0.0", port=8000) # as we configured it will run on Cloud/Remotly for Remote Servers
#     # mcp.run() # It will run Defaulty On The STDIO for Local Servers
